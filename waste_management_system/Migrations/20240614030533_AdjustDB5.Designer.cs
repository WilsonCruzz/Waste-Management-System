...
namespace waste_management_system.Migrations
{
    ...
    [Migration("20240614030533_AdjustDB5")]
    partial class AdjustDB5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("waste_management_system.Models.Observation", b =>
                {
            ...
            modelBuilder.Entity("waste_management_system.Models.Vehicle", b =>
                {
                    b.Property<int>("VehicleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("waste_management_system.Models.Observation", b =>
                {
                    b.HasOne("waste_management_system.Models.PickUpRequest", "PickUpRequests")
            ...
            modelBuilder.Entity("waste_management_system.Models.PickUpRequest", b =>
                {
                    b.HasOne("waste_management_system.Models.RequestStatus", "RequestStatuses")
                        .WithMany("PickUpRequests")
                        .HasForeignKey("RequestStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("waste_management_system.Models.TypeOfWaste", "TypeOfWastes")
                        .WithMany("PickUpRequests")
                        .HasForeignKey("TypeOfWasteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("waste_management_system.Models.UserProfile", "UserProfiles")
                        .WithMany("PickUpRequests")
            ...
            modelBuilder.Entity("waste_management_system.Models.TypeOfWaste", b =>
                {
                    b.HasOne("waste_management_system.Models.Vehicle", "Vehicles")
                        .WithMany("TypeOfWastes")
            ...
            modelBuilder.Entity("waste_management_system.Models.UserProfile", b =>
                {
                    b.HasOne("waste_management_system.Models.UserStatus", "UserStatuses")
